...
| `3.32.0` | iOS SDK `5.0.0` - `5.0.1` 的 `~> 3.18` 范围 | 已完成 | `native-3.32.0-20260918-092359`；demo 样本 |
| `3.20.2` | iOS SDK `5.0.0` - `5.0.1` 的 `~> 3.18` 范围 | 已完成 | `native-3.20.2-20260914-151006` |
| `3.20.1` | iOS SDK `5.0.0` - `5.0.1` 的 `~> 3.18` 范围 | 已完成 | `native-3.20.1-20260917-164509`；demo 样本 |
...
| 9 | `3.18.0` | 正式版 | `ios5.0.1` | `~> 3.18` 范围下限 | 待处理 |
| 10 | `3.14.1` | 正式版 | `ios4.38.4` | iOS SDK 4.x 插件路径，待真实请求确认 | 待处理 |
| 11 | `3.14.0` | 正式版 | `ios4.38.4` | iOS SDK 4.x 插件路径，待真实请求确认 | 待处理 |
| 12 | `5.5.0` | 正式版 | 待定 | 当前没有 iOS SDK tag 固定依赖该版本 | 待处理，排期最后 |
